...
describe('Tests', () => {
    ...
    test('getToken()', async () => {
        ...
        const result = await (0, webhookSiteHandler_1.getToken)();
    ...
    test('getLatesWebhookContent()', async () => {
        ...
        const result = await (0, webhookSiteHandler_1.getLatesWebhookContent)('tokenId');
    ...
    test('collectWebhooks()', async () => {
        ...
        const result = await (0, webhookSiteHandler_1.collectWebhooks)('tokenId');
    ...
    test('collectEmails()', async () => {
        ...
        const result = await (0, webhookSiteHandler_1.collectEmails)('tokenId');
        expect(mockedAxios.get).toHaveBeenCalledTimes(1);
